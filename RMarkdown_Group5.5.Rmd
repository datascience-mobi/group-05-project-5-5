...
SOX11 tends to be differently methylated in cancer samples. This observation can be made because MCL can be devided into 2 groups: SOX11 positive and SOX11 negative patients (Ferrando, 2013). Depending on this status, different clinical outcome can be observed (Ferrando, 2013).
