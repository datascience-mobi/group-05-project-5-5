...
>>>>>>> parent of 0f883ce... updated pca part'
...
top_genes_beta_values <-
  cbind(top_genes_beta_values,
        Mean_Difference = top_genes_beta_values[, 11] - top_genes_beta_values[, 12])

plot(
  x = top_genes_beta_values[, 13],
  y = -log10(p_value_each_gene[, 1]),
