...
After that we even had negative correlation which was not optimal but we faced too much data loss if we would have tried to procede in reducing more.
...
predict(regression_model_cross_validation, newdata = regression_data_uncorrelated_genes, type = "response")
