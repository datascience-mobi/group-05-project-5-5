...
#volcano_upper_right <- volcano_data[which(volcano_data["Fold_Change"] > 5 & volcano_data["p_value"] < 0.01)]
...
ENSG00000243702:
RNA, 7SL, Cytoplasmic 638, Pseudogene: It is reportes to be a part of the signal recognition particle of the ribonucleoprotein complex. It is important for transfer of signal bearing protein into a membrane or transfer to endoplasmatic reticulum for secretion. 
(Safran et al., 2010)

ENSG00000253822:
Immunoglobulin Lambda Variable 3-24: Encodes for a part of the N-terminal variable region of the light chains in a immunoglobulin moleculare, which are the antigen recognition molecules of B cells.
(Lefranc, 2014)(Safran et al., 2010)

ENSG00000238622:
Small Nucleolar RNA, C/D Box 97: The gene is from a group of non-coding RNAs. They are reported to have several roles in the cell, but one of the most prominent ones is functioning as guide RNAs in post-transcriptional synthesis of 2′-O-methylated nucleotides.
(Vitali et al., 2003)(Safran et al., 2010)

ENSG00000207504:
RNA, U6 Small Nuclear 1031, Pseudogene: Have been proposed to be a part of the active center of the spliceosome.They function during the first and second step of the splicing process.
(Hu et al., 2004)(Safran et al., 2010)

ENSG00000244433:
piggyBac transposable element derived 4 pseudogene 7: short inverted-repeat-type DNA transposable element which was oroginally found in a moth genome, but similar sequences have also been found in humans. Possible function as a transposase, which catalyses the movement of the transposon within the genome. 
(Sarkar et al., 2003)(Safran et al., 2010)

ENSG00000279415:
Uncategorized gene, and is affiliated with the lncRNA class.
(Safran et al., 2010)

ENSG00000270336:
Protein Phosphatase 2, Catalytic Subunit, Beta Isozyme (PPP2CB) Pseudogene: Has been reported to code fo the catalytic subunit of theThis gene encodes the phosphatase 2A catalytic subunit. This phosphatase has been involved in the negative control of cell growth and division.
(Safran et al., 2010) (Götz, J., 1998)
