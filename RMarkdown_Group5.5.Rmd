...
```
There is only one gene which p value is under 0.01 
...
fold <- top_genes_beta_values$Mean_Healthy - top_genes_beta_values$Mean_Cancer
...
abline(v = -fold_threshold, col = "red", lwd = 2)
abline(h = -log10(pvalue_threshold), col = "green", lwd = 2)
